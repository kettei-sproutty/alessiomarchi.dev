  ...
  return (
    <div className="space-y-2">
      ...
      <section title="Simple Buttons" className="space-x-3">
        ...
        <Button ariaLabel="Button secondary" theme={"secondary"}>Secondary</Button>
        <Button ariaLabel="Button error" theme={"error"}>Error</Button>
        <Button ariaLabel="button info" theme={"info"}>Info</Button>
      </section>
    </div>
  );
};
